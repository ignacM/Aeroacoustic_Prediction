...
if __name__ == '__main__':
    ...
    # Load models:
    svm_pol = joblib.load('../models/SVM_regressor_pol.pkl')
    gpr_pol = joblib.load('../models/GPR_regressor_pol.pkl')
    gbr_pol = joblib.load('../models/GBR_regressor_pol.pkl')
    scaler_pol = joblib.load('../models/scaler_pol.pkl')



    polar_df = pd.read_csv('../Data/dec22/x_validation_polar.csv')
